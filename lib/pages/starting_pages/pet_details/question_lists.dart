...
import 'package:pet_care_app/pages/starting_pages/pet_details/model/breed_selection_widget.dart';
import 'package:pet_care_app/pages/starting_pages/pet_details/model/image_selector.dart';
import 'package:pet_care_app/pages/starting_pages/pet_details/model/questions.dart';
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Image.asset('assets/intro_images/4.png'),
          ),
        ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Image.asset('assets/intro_images/5.png'),
          ),
        ),
      ],
    ),
